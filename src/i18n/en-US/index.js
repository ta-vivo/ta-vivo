...
export default {
  common: {
    ...
    overview_tool: "Overview of the tool",
    quick_setup: "Quick setup guide",
    creating_checks: "Creating Checks",
    setting_targets: "Setting up service targets",
    configuring_intervals: "Configuring check intervals",
    specifying_timezone: "Specifying timezone for each check",
    integrations: "Integrations",
    discord_integration: "Adding Discord integration",
    email_notifications: "Setting up Email notifications",
    slack_integration: "Configuring Slack integration",
    telegram_alerts: "Enabling Telegram alerts",
    whatsapp_notifications: "Managing WhatsApp notifications",
    status_pages: "Status Pages",
    create_dashboard: "Creating a dynamic dashboard",
    customize_layout: "Customizing status page layout",
    share_information: "Sharing information with teams",
    log_history: "Log History",
    viewing_logs: "Viewing check logs",
    tracking_uptime: "Tracking uptime and response times",
    analyzing_data: "Analyzing historical data",
    timezone_configuration: "Timezone Configuration",
    managing_timezones: "Managing timezones for checks",
    managing_general_timezones: "Managing general timezones",
    faqs: "FAQs",
    frequently_asked_questions: "Frequently asked questions",
    troubleshooting_issues: "Troubleshooting common issues",
  ...
  messages: {
    ...
    helpCenter: {
      ...
      overviewDescription1: 'Welcome to the tool`s help center! 👋',
      overviewDescription2: 'Our tool is designed to monitor APIs or web services based on a configurable time interval and send notifications if the service is down or not responding.',
      overviewDescription3: 'With our user-friendly interface, you can easily create checks to set up service targets, configure check intervals, and specify timezones for each check.',
      overviewDescription4: 'Take advantage of our integrations, including Discord, Email, Slack, Telegram, and WhatsApp, to receive notifications through your preferred channels.',
      overviewDescription5: 'Create dynamic dashboards for status pages, customize layouts, and share important information with your teams. Additionally, track the log history, view check logs, analyze historical data, and manage timezones effortlessly.',
      overviewDescription6: 'If you have any questions or need assistance, our support team is here to help. Start exploring the sections below to learn more and get started with our tool!',
      troubleshootingDescription: 'Having issues? Find quick solutions here. Our troubleshooting guide helps you overcome common problems with ease. Get back on track and maximize your monitoring capabilities. Explore below for tips and fixes.',
      cantFindSpecificIssue: 'Can`t find your specific issue? Reach out to our support team for personalized assistance.',
      targetNotValid: 'The target is not valid',
      targetNotValidDescription1: 'The target is not valid" typically refers to an issue where the specified target for monitoring is deemed invalid. This can occur due to various reasons, such as:',
      targetNotValidDescription2: '<strong>Invalid URL:</strong> The URL provided for the service or API is incorrect or improperly formatted. Double-check the URL and ensure it follows the correct structure (e.g., starting with <strong>"http://"</strong> or <strong>"https://"</strong>).',
      targetNotValidDescription3: '<strong>Service Unavailable:</strong> The service or API being monitored is currently down or experiencing technical difficulties. Verify the service`s status and try again later.',
      targetNotValidDescription4: '<strong>VPN Interference:</strong> If you are using a VPN (Virtual Private Network) connection, it may interfere with the monitoring process. Temporarily disable the VPN and retry monitoring the target.',
      targetNotValidDescription5: '<strong>Authentication Requirements:</strong> Some services or APIs require authentication methods, such as API keys, tokens, or credentials. Ensure that you have provided the necessary authentication details correctly to access the target.',
      targetNotValidSoluctionTitle: 'To resolve this issue, consider the following steps:',
      targetNotValidSolution1: 'Verify the accuracy of the target URL and ensure it follows the correct format.',
      targetNotValidSolution2: 'Check the status of the service or API to ensure it is operational.',
      targetNotValidSolution3: 'Temporarily disable any VPN connections that might be interfering with the monitoring process.',
      targetNotValidSolution4: 'Review the authentication requirements for the target and ensure the necessary credentials are provided.',
    },
    errors: {
